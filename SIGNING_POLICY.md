...
Public Android releases use one persistent signing identity starting with version 0.3.3.
...
The old private-repository application identity is intentionally not preserved. Users migrating from private 0.3.2 or earlier uninstall once and install public 0.3.3. Public 0.3.3 and later remain update-compatible with each other.
